...
## Objectif
Créer une image bootable Linux qui démarre en mode Live USB et lance automatiquement l'interface NEXOS en plein écran.

## Structure
- `build.sh` : script de génération de l'ISO Debian live.
- `config/package-lists/nexos.list.chroot` : packages inclus dans l'image.
